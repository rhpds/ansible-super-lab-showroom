...
** Completion of xref:10-platform-workspace.adoc[Lab 1-1. Introduction and exploration of Dev Spaces Workspace]]
...
+
image::41-lightspeed-mcp/librechat-edit-secret.png[Edit the librechat-credentials-env Secret]
+
...
+
image::41-lightspeed-mcp/librechat-edit-secret-value.png[Edit ANSIBLE_MCP_TOKEN in the librechat-credentials-env Secret]
+
...
+
image::41-lightspeed-mcp/librechat-pods-filter.png[Filter the librechat Pods by Label]
+
...
+
image::41-lightspeed-mcp/librechat-delete-pod.png[Delete the librechat Pod]
+
...
+
image::41-lightspeed-mcp/librechat-login-page.png[LibreChat Login Page]
+
...
+
image::41-lightspeed-mcp/librechat-enable-model.png[Enable the {litellm_available_models_list} Model in LibreChat]
+
...
+
image::41-lightspeed-mcp/librechat-enable-mcp.png[Enable aap MCP Server in LibreChat]
+
...
image::41-lightspeed-mcp/librechat-chat-result.png[LibreChat Chat Result]
...
image::41-lightspeed-mcp/opencode-mcp-invoke.png[OpenCode MCP Tool Invocation]
