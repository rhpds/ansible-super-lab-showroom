...
data:
  ...
  OPENCODE_CONFIG: /project/devspaces-example/opencode.json
----
+
...
Create a new file named `opencode.json` at the root of the `devspaces-example` workspace containing the following:
