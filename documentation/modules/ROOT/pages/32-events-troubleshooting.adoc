...
-a "Get-NetTCPConnection -LocalPort 80" \
...
* **Remediation Job Fails:** Check the **Jobs** tab in Automation Controller. Ensure the `Windows Admin Credential` hasn't expired.
