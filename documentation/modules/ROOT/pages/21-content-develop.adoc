...
+
image::21-content-develop/aap_inventories.png[AAP Inventories]
+
. Select **super-lab**
...
+
image::21-content-develop/aap_run_command.png[Run Command]
+
. For **Module** choose **win_ping** from the drop-down then **Next**
+
image::21-content-develop/aap_win_ping.png[Module]
+
...
+
image::21-content-develop/aap_run_command_credential.png[Credential]
+
...
+
image::21-content-develop/aap_run_command_results.png[Results]
+
...
+
image::21-content-develop/dev_spaces_open_folder.png[Open Folder]
+
...
+
image::21-content-develop/ansible_creator_collection.png[Ansible Creator - Collection]
...
. Click **Create**
+
image::21-content-develop/ansible_creator_role1.png[Ansible Creator - Collection]
+
...
+
image::21-content-develop/ansible_creator_role2.png[Ansible Creator - Collection]
...
image::21-content-develop/collection_dir_tree.png[Collection Roles]
...
+
image::21-content-develop/web_server_role.png[Web Server Role]
...
. The file structure should look like this:
+
image::21-content-develop/log_shipper_role.png[Log Shipper Role]
...
+
image::21-content-develop/lab_playbooks_dir.png[Lab Playbooks directory]
...
+
image::21-content-develop/group_vars_all.png[group_vars all]
+
...
+
image::21-content-develop/dev_spaces_venv.png[Dev Spaces Virtual Environment Question]
...
+
image::21-content-develop/playbook_dir_with_collection_link.png[Linked Collection Directory]
+
