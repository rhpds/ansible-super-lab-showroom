...
+
image::32-events-automated-reactive-remediation/eda-projects-sync.png[Sync EDA Project]
...
+
image::32-events-automated-reactive-remediation/eda-ra-create.png[Create Rulebook Activation]
...
+
image::32-events-automated-reactive-remediation/eda-ra-disable-check-kafka.png[Confirm Disable EDA Rulebook Activation]
