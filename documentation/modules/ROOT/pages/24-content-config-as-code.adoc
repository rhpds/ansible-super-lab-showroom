...
* **Prepares you for:** Using Config as Code to install and configure AAP
...
+
image::24-content-config-as-code/installed-operators-aap.png[Installed Operators in the AAP Project]
+
