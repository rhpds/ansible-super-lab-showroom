...
+
image::22-content-build/api-token-overview.png[API Token Overview]
+
. On the API Token page, click the **Generate token** button. Your API token will be displayed.
+
image::22-content-build/api-token-generate.png[Generate an API Token]
+
...
+
image::22-content-build/navigate-namespaces.png[Namespaces navigation]
+
...
+
image::22-content-build/create-namespace.png[Namespace creation form]
...
+
image::22-content-build/collections-approvals-pending.png[Approve the Collection]
+
...
+
image::22-content-build/collections-approvals-selection.png[Select Collection to Approve]
+
. Select the _Yes, I confirm that I want to approve these 1 collections._ checkbox and click **Approve collections** button.
+
image::22-content-build/collections-approvals-approve-collection.png[Pending Approval Collection]
+
...
+
image::22-content-build/pah-collections.png[PAH Collections]
...
+
image::22-content-build/create-remote-registry.png[Create Remote Registry]
+
...
+
image::22-content-build/create-remote-registry-details.png[Create Remote Registry Details]
+
...
+
image::22-content-build/create-execution-environment.png[Create Execution Environment]
+
...
+
image::22-content-build/create-execution-environment-form.png[Create Execution Environments Form]
+
...
+
image::22-content-build/execution-environment-sync.png[Sync Execution Environment]
+
...
+
image::22-content-build/execution-environment-confirm-sync.png[Confirm Sync Execution Environment]
+
...
+
image::22-content-build/edit-certified-remote.png[Edit RH-Certified Repository]
+
...
. Click *Save remote*
+
image::22-content-build/edit-certified-details.png[Edit Details]
+
. Navigate to *Automation Content* -> *Repositories*, next to *rh-certified* click the kebob (3 dots) and select *Sync repository*
+
image::22-content-build/sync-certified-repository.png[Sync Repository]
+
. In the final dialog, leave the default values and click **Sync**.
+
image::22-content-build/sync-repo-confirm.png[caption="Confirm Sync", role="thumb"]
...
+ 
image::22-content-build/gitea-homepage.png[Gitea Homepages]
+
...
+ 
image::22-content-build/gitea-login.png[Gitea Login Page]
+
. Once authenticated, in the top left of the web interface, click on the **+** symbol and select **New Repository**.
+
image::22-content-build/gitea-navigate-new-repository.png[Navigate to new Gitea Repository]
+
. On the *New Repository* page, enter `red_hat_one_super_lab` in the *Repository Name* field.
+ 
image::22-content-build/gitea-new-repository-name.png[Gitea New Repository]
+
. Leave everything else as default and click on the button at the bottom, **Create Repository**.

image::22-content-build/gitea-create-repository.png[Gitea Create Repository]
...
+
image::22-content-build/devspaces-git-auth.png[Gitea Repository Containing Collection Content]
+
...
+
image::22-content-build/gitea-repository.png[Dev Spaces Git Authentication]
...
+
image::22-content-build/collection-uploaded.png[Confirm Collection Upload]
...
+
image::22-content-build/collection-verify-new-version.png[Verify New Collection Version]
...
+
image::22-content-build/execution-environment-versions.png[View EE Versions]
