...
+
image::13-platform-aap_on_openshift/installed-operators-aap.png[Installed Operators in the AAP Project]
+
...
+
image::13-platform-aap_on_openshift/aap-operator-all-instances.png[All Instances of the AAP Operator]
+
...
image::13-platform-aap_on_openshift/aap-operator-aap-details.png[AAP Instance Details]
...
+
image::13-platform-aap_on_openshift/aap-deployments.png[AAP Deployments]
+
...
image::13-platform-aap_on_openshift/aap-deployment-details.png[AAP Deployment Details]
...
+
image::13-platform-aap_on_openshift/aap-pods.png[AAP Pods]
+
...
+
image::13-platform-aap_on_openshift/aap-pod-details.png[AAP Pod Details]
+
...
+
image::13-platform-aap_on_openshift/aap-pod-logs-task.png[AAP Pod Logs - Task Container]
+
...
+
image::13-platform-aap_on_openshift/aap-pod-logs-rsyslog.png[AAP Pod Logs - Rsyslog Container]
+
...
+
image::13-platform-aap_on_openshift/aap-pvcs.png[AAP Persistent Volume Claims]
+
...
image::13-platform-aap_on_openshift/aap-pvc-details.png[AAP Persistent Volume Claim Details]
...
+
image::13-platform-aap_on_openshift/aap-configmaps.png[AAP ConfigMaps]
+
...
+
image::13-platform-aap_on_openshift/aap-configmap-details.png[AAP ConfigMap Details]
+
...
+
image::13-platform-aap_on_openshift/aap-secrets.png[AAP Secrets]
+
* Click on **aap-admin-password**. Under `Details` we can see information about the secret and its data.
+
image::13-platform-aap_on_openshift/aap-secret-details.png[AAP Secrets]
+
...
+
image::13-platform-aap_on_openshift/aap-routes.png[AAP Routes]
+
...
+
image::13-platform-aap_on_openshift/aap-route-details.png[AAP Route Details]
+
...
image::13-platform-aap_on_openshift/aap-project.png[AAP Project Details]
...
+
image::13-platform-aap_on_openshift/aap-operatorhub.png[AAP OperatorHub]
+
...
+
image::13-platform-aap_on_openshift/aap-operator-install.png[AAP Operator Install]
+
...
+
image::13-platform-aap_on_openshift/aap-operator-install-2.png[AAP Operator Install - Namespace Selection]
+
. Click the **Install** button.
+
image::13-platform-aap_on_openshift/aap-operator-install-progress.png[AAP Operator Install - Namespace Selection]
+
...
image::13-platform-aap_on_openshift/aap-operator-install-success.png[AAP Operator Install Success]
...
+
image::13-platform-aap_on_openshift/aap-operator-secret-type.png[AAP Operator Secret Type Selection]
+
...
image::13-platform-aap_on_openshift/aap-operator-secret.png[AAP Operator Secret]
...
+
image::13-platform-aap_on_openshift/aap-operator-create-new.png[Create New AAP Instance]
...
+
image::13-platform-aap_on_openshift/aap-operator-resources.png[AAP Resources Tab]
...
+
image::13-platform-aap_on_openshift/aap-running.png[AAP Running Status]
...
image::13-platform-aap_on_openshift/aap-automationhub-status.png[AutomationHub Status]
...
+
image::13-platform-aap_on_openshift/aap-settings-troubleshooting.png[AAP Automation Execution Settings]
+
. Click on the **Edit** button.
. Uncheck the **Release Receptor Work** checkbox.
. Click the **Save** button.

image::13-platform-aap_on_openshift/aap-receptor-work.png[AAP Receptor Work Setting]
...
+
image::13-platform-aap_on_openshift/aap-instance-groups.png[AAP Instance Groups]
+
...
+
image::13-platform-aap_on_openshift/aap-edit-instance-group.png[Update Default Instance Group]
+
...
+
image::13-platform-aap_on_openshift/aap-job-pods.png[Job Pods]
+
...
image::13-platform-aap_on_openshift/aap-container-group-pod.png[AAP Container Group Pod Labels]
