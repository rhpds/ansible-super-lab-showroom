...
For this lab, we have have provided a link:https://code.visualstudio.com/docs/editing/workspaces/workspaces[.code-workspace,window=_blank] configuration that included these extensions along with additional configurations to curate your development environment. See https://github.com/redhat-cop/ansible-devspaces/blob/main/.code-workspace for the source of this workspace configuration.
...
. https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html/user_guide/assembly_getting-started_user_guide#authenticating-to-a-git-server-from-a-workspace_user_guide[Authenticating to a Git server from a Workspace^]
. https://github.com/redhat-cop/ansible-devspaces/[Source for the Dev Space Workspace^]
