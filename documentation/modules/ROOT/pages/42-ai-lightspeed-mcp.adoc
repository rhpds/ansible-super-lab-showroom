...
+
image::42-lightspeed-mcp/installed-operators-aap.png[Installed Operators in the aap Project]
+
...
+
image::42-lightspeed-mcp/ansible-automation-platform-instances.png[Ansible Automation Platform Instances in the aap Project]
+
...
+
image::42-lightspeed-mcp/api-token-overview.png[API Token Overview]
+
...
+
image::42-lightspeed-mcp/api-token-details.png[API Token Creation Details]
+
...
+
image::42-lightspeed-mcp/librechat-edit-secret.png[Edit the librechat-credentials-env Secret]
+
...
+
image::42-lightspeed-mcp/librechat-edit-secret-value.png[Edit ANSIBLE_MCP_TOKEN in the librechat-credentials-env Secret]
+
...
+
image::42-lightspeed-mcp/librechat-pods-filter.png[Filter the librechat Pods by Label]
+
...
+
image::42-lightspeed-mcp/librechat-delete-pod.png[Delete the librechat Pod]
+
...
+
image::42-lightspeed-mcp/librechat-login-page.png[LibreChat Login Page]
+
...
+
image::42-lightspeed-mcp/librechat-enable-model.png[Enable the {litellm_available_models_list} Model in LibreChat]
+
...
+
image::42-lightspeed-mcp/librechat-enable-mcp.png[Enable aap MCP Server in LibreChat]
+
...
image::42-lightspeed-mcp/librechat-chat-result.png[LibreChat Chat Result]
...
+
image::42-lightspeed-mcp/openshift-overview-import-yaml.png[Import YAML option in OpenShift console]
...
+
image::42-lightspeed-mcp/dev_spaces_shortcut.png[OpenShift Dev Spaces Shortcut Icon]
+
...
+
image::42-lightspeed-mcp/restart-devspaces-workspace.png[Restart Dev Spaces Workspace option]
+
...
image::42-lightspeed-mcp/opencode-overview.png[OpenCode Overview]
...
image::42-lightspeed-mcp/opencode-status.png[OpenCode Status]
...
image::42-lightspeed-mcp/opencode-mcp-invoke.png[OpenCode MCP Tool Invocation]
