...
+
image::32-events-log-streaming/eda-projects-sync.png[Sync EDA Project]
...
+
image::32-events-log-streaming/eda-ra-create.png[Create Rulebook Activation]
...
+
image::32-events-log-streaming/eda-ra-disable-check-kafka.png[Confirm Disable EDA Rulebook Activation]
