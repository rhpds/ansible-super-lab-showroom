...
[source,yaml,role=execute,subs="verbatim,attributes"]
----
ansible-navigator --execution-environment-image aap-aap.apps.{openshift_cluster_ingress_domain}/my-pah-ee:1.1 run test_pah_ee.yml  --mode stdout
----
+
[source,output]
----
...
+
image::22-content-execute/load-automation-hub-token.png[Load Automation Hub Token]
+
