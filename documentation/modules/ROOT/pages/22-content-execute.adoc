...
+
NOTE: Uncheck *Ansible Galaxy* as no community collections are used in this lab.
+
...
Finally, synchronize the `validated` repository to pull in the new collections within the _Repositories_ page.
