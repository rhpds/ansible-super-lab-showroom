...
[.sidebar]
****
* **Before you start:** Access to Dev Spaces and AAP in xref:environment-details.adoc[Environment Details], content from xref:21-content-build.adoc[Lab 2-2. Develop a custom Execution Environment]
