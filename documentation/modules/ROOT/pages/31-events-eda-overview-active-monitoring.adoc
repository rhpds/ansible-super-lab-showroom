...
+
image::31-events-eda-overview-active-monitoring/automation-controller-projects-overview.png[Navigate to Projects,link=self,window=blank]
+
. Synchronize the *Lab Playbooks* project
+
image::31-events-eda-overview-active-monitoring/automation-controller-projects-sync.png[Synchronize Project,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-templates-overview.png[Navigate to Templates,link=self,window=blank]
+
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-job-template-create.png[Create Job Template Dialog,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/eda-credentials-overview.png[EDA Credentials Overview,link=self,window=blank]
+
. Select *Create credential*
+
image::31-events-eda-overview-active-monitoring/eda-credentials-create.png[Create Credential Dialog,link=self,window=blank]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-credentials-aap-create.png[Create AAP Credential,link=self,window=blank]
...
. Click **Create Credential**
+
image::31-events-eda-overview-active-monitoring/eda-credentials-de-create.png[Create Decision Environment Credential,link=self,window=blank]
...
. Click **Create Credential**
+
image::31-events-eda-overview-active-monitoring/eda-credentials-scm-create.png[Create Gitea Credential,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/eda-projects-overview.png[EDA Projects Overview,link=self,window=blank]
+
...
. Click **Create project**
+
image::31-events-eda-overview-active-monitoring/eda-projects-create.png[Create EDA Project,link=self,window=blank]
+
. Ensure the project syncs properly
+
image::31-events-eda-overview-active-monitoring/project-sync.png[Project Sync,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/eda-de-overview.png[EDA Decision Environments,link=self,window=blank]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-de-dialog.png[EDA Decision Environments Dialog,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-overview.png[EDA Rulebook Activations Overview,link=self,window=blank]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-create.png[Create Rulebook Activation Dialog,link=self,window=blank]
+
. You can now click on *check_website* to view details
+
image::31-events-eda-overview-active-monitoring/rulebook-running.png[Rulebook Running,link=self,window=blank]
+
. To view more detail, select *History* to watch activity. Review this tab until it is in *Running* state
+
image::31-events-eda-overview-active-monitoring/rulebook-running-history.png[Rulebook History,link=self,window=blank]
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-jobs-overview.png[Automation Controller Jobs Overview,link=self,window=blank]
+
. Confirm that a new job for `Start IIS` has been triggered by the `eda` user.
+
image::31-events-eda-overview-active-monitoring/automation-controller-eda-trigger-job-check.png[Automation Controller Jobs Triggered,link=self,window=blank]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-disable-url-check.png[Disable EDA Rulebook Activation,link=self,window=blank]
+
. Select the checkbox to confirm disabling and click **Disable rulebook activations**
+
image::31-events-eda-overview-active-monitoring/eda-ra-disable-confirm.png[Confirm Disable EDA Rulebook Activation,link=self,window=blank]
