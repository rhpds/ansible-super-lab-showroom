...
+
image::31-events-eda-overview-active-monitoring/automation-controller-projects-overview.png[Navigate to Projects]
+
. Synchronize the *Lab Playbooks* project
+
image::31-events-eda-overview-active-monitoring/automation-controller-projects-sync.png[Synchronize Project]
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-templates-overview.png[Navigate to Templates]
+
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-job-template-create.png[Create Job Template Dialog]
...
+
image::31-events-eda-overview-active-monitoring/eda-credentials-overview.png[EDA Credentials Overview]
+
. Select *Create credential*
+
image::31-events-eda-overview-active-monitoring/eda-credentials-create.png[Create Credential Dialog]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-credentials-aap-create.png[Create AAP Credential]
...
. Click **Create Credential**
+
image::31-events-eda-overview-active-monitoring/eda-credentials-de-create.png[Create Decision Environment Credential]
...
. Click **Create Credential**
+
image::31-events-eda-overview-active-monitoring/eda-credentials-scm-create.png[Create Gitea Credential]
...
+
image::31-events-eda-overview-active-monitoring/eda-projects-overview.png[EDA Projects Overview]
+
...
. Click **Create project**
+
image::31-events-eda-overview-active-monitoring/eda-projects-create.png[Create EDA Project]
+
. Ensure the project syncs properly
+
image::31-events-eda-overview-active-monitoring/project-sync.png[Project Sync]
...
+
image::31-events-eda-overview-active-monitoring/eda-de-overview.png[EDA Decision Environments]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-de-dialog.png[EDA Decision Environments Dialog]
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-overview.png[EDA Rulebook Activations Overview]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-create.png[Create Rulebook Activation Dialog]
+
. You can now click on *check_website* to view details
+
image::31-events-eda-overview-active-monitoring/rulebook-running.png[Rulebook Running]
+
. To view more detail, select *History* to watch activity. Review this tab until it is in *Running* state
+
image::31-events-eda-overview-active-monitoring/rulebook-running-history.png[Rulebook History]
...
+
image::31-events-eda-overview-active-monitoring/automation-controller-jobs-overview.png[Automation Controller Jobs Overview]
+
. Confirm that a new job for `Start IIS` has been triggered by the `eda` user.
+
image::31-events-eda-overview-active-monitoring/automation-controller-eda-trigger-job-check.png[Automation Controller Jobs Triggered]
+
...
+
image::31-events-eda-overview-active-monitoring/eda-ra-disable-url-check.png[Disable EDA Rulebook Activation]
+
. Select the checkbox to confirm disabling and click **Disable rulebook activations**
+
image::31-events-eda-overview-active-monitoring/eda-ra-disable-confirm.png[Confirm Disable EDA Rulebook Activation]
