...
+
image::26-pipelines/pipelines-gitea-repo-new-select.png[Select New Gitea Repository]
+
...
image::26-pipelines/pipelines-gitea-repo-new.png[New Gitea Repository]
...
image::26-pipelines/pipelines-clustertriggerbindings.png[Cluster Trigger Bindings]
...
image:26-pipelines/pipelines-pipeline.png[Ansible Collection CI Pipeline]
...
image::26-pipelines/pipelines-trigger-config.png[Pipeline Trigger Config]
...
image::26-pipelines/pipelines-webhook-url.png[Pipelines Webhook URL]
...
image::26-pipelines/pipelines-gitea-webhook-config.png[Webhook Configuration]
...
image::26-pipelines/pipelines-gitea-webhook-test.png[Test Webhook Delivery]
...
image::26-pipelines/pipelines-devspace-role-create.png[Create dad_joke Role]
...
image::26-pipelines/pipelines-pah-verify.png[Verify Collection in Automation Hub]
