...
* **Prepares you for:** Using Event-Driven Ansible for reactive monitoring using Filebeat and Kafka
...
+
[source,yaml,role=execute,title="/projects/lab_playbooks/rulebooks/check_kafka.yml",subs="verbatim,attributes,callouts"]
----
---
...
...
----
<1> Be sure this job template name matches the one created in the previous lab.
+
...
+
image::31-events-log-streaming/eda-ra-disable-check-kafka.png[Confirm Disable EDA Rulebook Activation]
