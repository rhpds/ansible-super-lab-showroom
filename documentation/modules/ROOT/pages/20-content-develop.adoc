...
----
+
After the roles were created, the following will be displayed.
+
[source,output]
----
...
----
+
The following will be displayed once the command completes:
+
[source,output]
----
...
----
+
IMPORTANT: Be sure to replace #{your_token}# with the token from step 2.
