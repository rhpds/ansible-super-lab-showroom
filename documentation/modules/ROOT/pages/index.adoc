...
.. xref:12-platform-aap_on_openshift.adoc[AAP on OpenShift]
.. xref:13-platform-aap_on_ocp_cac.adoc[AAP on OpenShift as Code]
. Content
[arabic]
.. xref:20-content-develop.adoc[Creating automation for Windows]
.. xref:21-content-build.adoc[Build a custom Execution Environment and Collection]
.. xref:22-content-execute.adoc[Create a Playbook and configure AAP to execute it all]
