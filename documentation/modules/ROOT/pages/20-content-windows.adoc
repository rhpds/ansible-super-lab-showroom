...
+
[source,yaml, title="/projects/lab_collection/roles/web_server/tasks/setup.yml"]
----
---
...
+
[source,yaml, title="/projects/lab_collection/roles/web_server/tasks/website.yml"]
----
---
...
+
[source,yaml, title="/projects/lab_collection/roles/web_server/tasks/validate.yml"]
----
---
...
+
[source,yaml, title="/projects/lab_collection/roles/log_shipper/tasks/prerequisites.yml"]
----
---
...
. Create a new task file in the `tasks` directory to handle setup requirements:
+
[source,yaml, title="/projects/lab_collection/roles/log_shipper/tasks/chocolatey.yml"]
----
---
...
+
[source,yaml, title="/projects/lab_collection/roles/log_shipper/tasks/filebeat.yml"]
----
---
