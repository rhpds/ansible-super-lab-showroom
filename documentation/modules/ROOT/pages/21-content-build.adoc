...
[.sidebar]
****
* **Before you start:** Access to Dev Spaces and AAP in xref:environment-details.adoc[Environment Details], content from xref:20-content-develop.adoc[Lab 2-1. Creating automation for Windows]
...
=== 7.3: Increment Collection and Version and Republish
