= Automation and AI SuperLab

Site content for the Automation and AI SuperLab.
...
[source,sh]
----
./lab-content # Location where all code for the lab is stored
...
[source,sh]
----
podman run --rm --name antora -e ANTORA_CONFIG=site.yml -v $PWD:/antora -p 8080:8080 -i -t ghcr.io/juliaaano/antora-viewer
----
...
[source,sh]
----
podman run --rm --name antora -e ANTORA_CONFIG=site.yml -v $PWD:/antora:z -p 8080:8080 -i -t ghcr.io/juliaaano/antora-viewer
----
